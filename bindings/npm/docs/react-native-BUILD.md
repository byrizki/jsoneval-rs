...
{
  "dependencies": {
    "@json-eval-rs/react-native": "file:../path/to/json-eval-rs/bindings/npm/packages/react-native"
  }
}
```
...
mkdir -p bindings/npm/packages/react-native/android/src/main/jniLibs/{arm64-v8a,armeabi-v7a,x86_64,x86}
