...
export interface JsonEvalJSIGlobal {
    ...
    validate(handle: string, data: string, context: string | null, validateReadonly?: boolean, includeSubforms?: boolean): string;
    validatePaths(handle: string, data: string, context: string | null, paths: string | null, validateReadonly?: boolean, includeSubforms?: boolean): string;
