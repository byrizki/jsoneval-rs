...
class JSONEval {
   ...
   * @throws {Error} If operation fails
   */
  async getEvaluatedSchemaByPaths(paths, skipLayout = false, format = _common.ReturnFormat.Nested) {
    this.throwIfDisposed();
  ...
  async getEvaluatedSchemaByPathsSubform(options) {
    ...
    return await this._callNativeJson('getEvaluatedSchemaByPathsSubform', options.subformPath, pathsJson, options.skipLayout || false, options.format !== undefined ? options.format : _common.ReturnFormat.Nested);
  }
