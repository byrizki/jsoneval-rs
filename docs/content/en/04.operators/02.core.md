---
title: 'Core'
description: "Core operators for accessing data and defining literal values."
navigation:
...
- **[if](logical#if)** - Conditional logic based on variable values
- **[missing](utility#missing)** - Check for missing variables
- **[ifnull](logical#ifnull)** - Provide fallback for null values
- **[Array Operators](array)** - Transform arrays using `var` with empty string
