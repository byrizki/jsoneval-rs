---
title: 'Logical'
description: "Boolean logic and conditional execution operators."
navigation:
...
- **[Comparison Operators](comparison)** - Generate boolean conditions
- **[missing](utility#missing)** - Check for missing keys
- **[Array Quantifiers](array#quantifiers)** - `all`, `some`, `none`
