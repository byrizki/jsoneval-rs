---
title: 'Array'
description: "Array transformation, filtering, and aggregation operators."
navigation:
...
- **[Comparison Operators](comparison)** - For filtering conditions
- **[Logical Operators](logical)** - Combine conditions
- **[Arithmetic Operators](arithmetic)** - Transform values
- **[Table Operators](table)** - Advanced array queries
