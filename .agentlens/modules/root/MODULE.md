...
| `examples/basic.rs` | 271 |  |
| `examples/basic_parsed.rs` | 262 |  |
| `examples/benchmark.rs` | 544 | 📊 |
| `examples/cache_demo.rs` | 255 |  |
| `examples/spaj_toggle.rs` | 105 |  |
| `tests/advanced_paths.rs` | 1 |  |
| `tests/array_tests.rs` | 560 | 📊 |
| `tests/basic_tests.rs` | 488 |  |
| `tests/check_static.rs` | 66 |  |
| `tests/compile_and_run_logic_context_tests.rs` | 252 |  |
| `tests/compile_and_run_logic_tests.rs` | 170 |  |
| `tests/compile_and_run_separate_tests.rs` | 162 |  |
| `tests/config_tests.rs` | 293 |  |
| `tests/core_validation_tests.rs` | 208 |  |
| `tests/date_offset_tests.rs` | 108 |  |
| `tests/date_tests.rs` | 398 |  |
| `tests/dependents_cascade_tests.rs` | 156 |  |
| `tests/edge_case_tests.rs` | 496 |  |
| `tests/eval_data_tests.rs` | 11 |  |
| `tests/excel_operators_tests.rs` | 356 |  |
| `tests/ffi_validation_tests.rs` | 75 |  |
| `tests/hidden_filtering_test.rs` | 306 |  |
| `tests/indexing_test.rs` | 107 |  |
| `tests/json_eval_tests.rs` | 920 | 📊 |
| `tests/json_parser_tests.rs` | 39 |  |
| `tests/logical_operator_crosscheck.rs` | 406 |  |
| `tests/logical_value_test.rs` | 167 |  |
...
| `tests/string_tests.rs` | 345 |  |
| `tests/sum_threshold_test.rs` | 69 |  |
| `tests/table_tests.rs` | 681 | 📊 |
...
| `tests/test_subforms.rs` | 659 | 📊 |
| `tests/timezone_integration_tests.rs` | 149 |  |
| `tests/verify_path_conversion.rs` | 55 |  |
| `tests/wasm_validation_tests.rs` | 68 |  |
